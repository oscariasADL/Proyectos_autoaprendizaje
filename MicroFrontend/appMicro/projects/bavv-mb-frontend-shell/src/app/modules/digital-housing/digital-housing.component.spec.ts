...
describe('DigitalHousingComponent', () => {
  let component: DigitalHousingComponent;
  let fixture: ComponentFixture<DigitalHousingComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DigitalHousingComponent);
