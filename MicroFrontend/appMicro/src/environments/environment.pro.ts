...
export const environment = {
  ...
  dataDog: {
    enable: false,
    applicationId: '9b7224db-e05a-4b47-af04-b2dd6c296ea1',
    clientToken: 'pubb0aaf97fb4b0cdf58102a9c9336b92f1',
    site: 'datadoghq.com',
    service: 'rb-mb-frontend'
  },
  encrypt: true,
  interchange_key: {
    interval_in_minutes: 660
  },
  log_request: false,
  clear_data: false,
  silent_enrollment: false,
  complementary_services: true,
  validate_automatic_otp: true,
  vibot: 'https://www.avvillas.com.co/bancadigital/vibot.html',
  benefitsUrl:
  ...
  remittancesActionsValues:
    'https://clientesremesas.accivalores.com/uni01/landing?t=',
  otp_sender_code: '85388',
  static_vector:
    // eslint-disable-next-line max-len
    '',
  biometric_secret:
    'd122cb3c874e8585fdd51c5870530b999d29b7c1222942e77702882c61928bf89610b22970e2a18c949eb40def9d15510837c7d223c22c37d9c0081192e0ef56',
  resources: {
    baseAssetsUrl: 'https://mb-pro-app-avvillas.avaldigitallabs.com',
    base: 'https://avvillas.com.co',
    base_img: './assets/img/'
  },
  api: {
    server_url: 'https://mb-api-avvillas.avaldigitallabs.com',
    server_parameter: 'https://mb-cache-avvillas.avaldigitallabs.com',
    services: {
      auth: {
      ...
      pfm: {
        ...
        adviser_aval: {
          ...
          consejero_aval_script:
            'https://d1vn9w0ia1pj5f.cloudfront.net/adl-idw-frontend-distribution-idw-agent/loader/index.es2017.js'
        }
      },
      wallets: {
  ...
  microfrontends: {
    ...
    creditCard: {
      remoteEntryUrl:
        'https://d2skrrvl8pp3e.cloudfront.net/module-federation/remoteEntry.js',
    ...
    digitalHousing: {
      remoteEntryUrl:
        'https://d3rwh2rtuh504r.cloudfront.net/bavv-vivienda-frontend-micro-shell-short-flows-mf/module-federation/remoteEntry.js',
    ...
    personalLoan: {
      remoteEntryUrl:
        'https://d1to65j7nc4bgu.cloudfront.net/bavv-libreinversion-frontend-micro-shell/module-federation/remoteEntry.js',
      exposedModule: './Module',
    ...
    spiKeys: {
      remoteEntryUrl:
        'https://d127rzjkt080sg.cloudfront.net/adl-spi-frontend-mfe-shell/remoteEntry.js',
    ...
    biometrics: {
      remoteEntryUrl:
        'https://d2si27d59ouarg.cloudfront.net/adl-biometria-frontend-bf-mfe-shell/remoteEntry.js',
      exposedModule: './routes',
  ...
  configCat: {
    sdkKey: 'configcat-sdk-1/NZHcCKv7KEeD8EHTQ3SzOA/0atPX8-wpkO65PnQR3luWw'
  },
  newRelic: {
