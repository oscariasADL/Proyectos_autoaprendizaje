  ...
  api: {
    ...
    services: {
      ...
      enrollment: {
        ...
        base_sf: '/auth/v1/enrollment',
        biometrics: '/auth/v1/enrollment/biometrics',
        biometrics_sf: '/auth/v1/enrollment/biometrics',
        silent: '/auth/v1/enrollment/silent'
      },
      core: {
        complementary_services: '/auth/v1/core/complementary-services',
        complementary_services_sf: '/auth/v1/core/complementary-services'
      },
      management: {
        ...
        forgot_password_sf: '/auth/v1/password/forgot',
        biometrics: '/auth/v1/password/forgot/biometrics',
        biometrics_sf: '/auth/v1/password/biometrics',
      ...
      management_tcd_server: {
        virtual_credit_card_create: '/digital-credit-card/v1/create',
        virtual_credit_card_edit: '/digital-credit-card',
        virtual_credit_card_list: '/digital-credit-card/v1/consult',
        virtual_credit_card_detail: '/digital-credit-card/v1/retrive',
        virtual_credit_card_cancel: '/digital-credit-card/v1/cancel',
        virtual_credit_card_forward: '/digital-credit-card/v1/forward',
        virtual_credit_card_modify: '/digital-credit-card/v1/modify'
      },
      security: {
      ...
      base: {
        ...
        spiAuthorization:
          '/product/product-information-server/v1/consent/consult',
        acceptSpiConsent:
          '/product/product-information-server/v1/consent/accept',
        ...
        suggest_keys: '/product/product-information-server/v1/spi/suggest-keys',
        ...
        modify_aval_tag:
          '/product/product-information-server/v1/spi/modify-tag-aval'
      },
      transactions: {
        ...
        transfers: {
          ...
          breB: '/transfers/v1/cel2cel',
          avvPhoneGetProductsByPhoneNumber:
            '/transfers/v1/find-products-by-phone-number',
          accountAvalKey: '/transfers/v1/spi/account-keys-user',
          spiKeyData: '/transfers/v1/spi/account-keys-user'
        },
        rsa_spi: '/product-operation-server/v1/rsa-spi',
        rsa_spi_block: '/product-operation-server/v1/rsa-spi/block'
      },
      pocketWithReturns: {
        detail: '/pockets/v1/pocket/detail',
        update: '/pockets/v1/product/pocket',
        create: '/pockets/v1/create'
      },
      pocket: {
        ...
        detail: '/pockets/v1/pocket/detail',
        delete:
          '/pockets/v1/product/{parent_account_type}/{parent_account_id}/pocket/{pocket_id}/{pocket_type}',
      ...
      contact: {
        ...
        spi: {
          add_contact: '/contacts/v1/spi/add-contact',
          update_contact: '/contacts/v1/spi/update-contact',
          contact: '/contacts/v1/spi/get-contact'
        }
      },
      payments: {
      ...
      pfm: {
        ...
        credit_card_balances_summary:
          '/pfm/v1/{accountId}/balances-summary?start_date={startDate}&end_date={endDate}?credit_card=1',
        categories_of_movements: '/pfm/v1/categories-of-movements',
        movements_by_category: '/pfm/v1/movements',
        change_category: '/pfm/v1/movements/change-category',
        adviser_aval: {
      ...
      wallets: {
        card_list: '/wallets/v1/card-list',
        createWallet: '/wallets/v1/create-wallet',
        prepare_digitization: '/wallets/v1/prepare-enrollcard',
        last_token: '/tokenization/v1/last-token',
        activate_token: '/tokenization/activation'
      },
      remittance: {
        customer_validate: '/transfers/v1/remittance/customer-validate',
        register_account: '/transfers/v1/remittance/register-account'
      }
    }
  },
  microfrontends: {
