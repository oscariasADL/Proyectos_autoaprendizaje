...
import { TransfersSendMoneyTowardCellPhoneComponent } from './transfers-send-money-toward-cell-phone.component';

describe('TransfersSendMoneyTowardCellPhoneComponent', () => {
  let component: TransfersSendMoneyTowardCellPhoneComponent;
  let fixture: ComponentFixture<TransfersSendMoneyTowardCellPhoneComponent>;
  let modalSpy;
  let modalCtrlSpy;
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [TransfersSendMoneyTowardCellPhoneComponent],
