...
describe('TransfersRequestMoneyPage', () => {
  let component: TransfersRequestMoneyPage;
  let fixture: ComponentFixture<TransfersRequestMoneyPage>;

  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [TransfersRequestMoneyPage],
    ...
    fixture = TestBed.createComponent(TransfersRequestMoneyPage);
  ...
  it('should call transferRequestMoney', () => {
    const product = new ProductFactory().create();
    component.form.get('fromProduct').setValue(product);
    ...
    expect((component as any).transferRequestMoney()).toBeUndefined();
  });
});
