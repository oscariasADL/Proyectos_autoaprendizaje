...
describe('TransfersAvvAccountPage', () => {
  let component: TransfersAvvAccountPage;
  let fixture: ComponentFixture<TransfersAvvAccountPage>;

  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [TransfersAvvAccountPage],
    ...
    fixture = TestBed.createComponent(TransfersAvvAccountPage);
  ...
  it('should call transferAvvAccount', () => {
    const product = new ProductFactory().create();
    component.form.get('fromProduct').setValue(product);
    ...
    expect((component as any).transferAvvAccount()).toBeUndefined();
  });
});
