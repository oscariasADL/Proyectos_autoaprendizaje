...
@Component({
  ...
  templateUrl: './modal-time-expired-same-device.component.html',
  styleUrls: ['./modal-time-expired-same-device.component.sass'],
  standalone: true,
  imports: [IonicModule, CommonModule, RouterModule, GlobalPipesModule]
})
export class ModalTimeExpiredSameDeviceComponent {
